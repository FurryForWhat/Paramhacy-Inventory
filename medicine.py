...
def display_medicine():
    ...
    tools.print_with_borders("➕Press 1 to add medicine")
    tools.print_with_borders("➕Press 2 to search medicine")
    tools.print_with_borders("➕Press 3 to delete medicine")
    tools.print_with_borders("➕Press 4 to update medicine")
    tools.print_with_borders("➕Press 5 to purchase medic list")
    tools.print_with_borders("➕Press 6 to main menu")
...
def add_medicine():
    ...
    status = status.lower()
    check_status = tools.status_check(int(quantity))
...
def to_purchase():
    ...
    for i in collection.find({},{"_id":0,"medic name":1,"medic ID":1,"sale_director":1,"quantity":1,"status":1}): 
        if i["status"] == False:
            print(f"{i["medic name"]} from sale director: {i["sale_director"]}")
